package com.jbtits.otus.lecture9.serializers;
...
//    }
    ...
    public String generateInsert(final String tableName, final Object source) {
        return "insert into " + tableName + " (name, age) values (\'John Beam\', 10)";
    }

    public String generateSelect(final String tableName, final Object source) {
